/**
 * Identidade verbal da Falcão Saúde Ocupacional. Centraliza copy
 * (taglines, descrições) para evitar strings espalhadas pelo código.
 */
export const brand = {
  name: 'Falcão Saúde Ocupacional',
  shortName: 'Falcão',
  legalName: 'Falcão Construções e Engenharia',
