...
export const CID_CATALOG: CidEntry[] = [
  ...
  {
    code: 'M51',
    description: 'Outros transtornos de discos intervertebrais',
  ...
  {
    code: 'M77',
    description: 'Outras entesopatias (ex.: epicondilite)',
    category: 'Osteomuscular',
  },
  {
    code: 'M79',
    description: 'Outros transtornos dos tecidos moles não classificados',
    category: 'Osteomuscular',
  },
  {
    code: 'M25',
    description: 'Outros transtornos articulares não classificados',
    category: 'Osteomuscular',
  },
  ...
  {
    code: 'J62',
    description: 'Pneumoconiose devida a poeira contendo sílica',
    category: 'Respiratório',
  },
  {
    code: 'J63',
    description: 'Pneumoconiose devida a outras poeiras inorgânicas',
    category: 'Respiratório',
  },
  {
    code: 'J66',
    description: 'Doença das vias respiratórias devida a poeiras orgânicas específicas',
    category: 'Respiratório',
  },
  ...
  {
    code: 'F43',
    description: 'Reações ao estresse grave e transtornos de adaptação',
  ...
  {
    code: 'Z73',
    description: 'Problemas relacionados com dificuldade em controlar o modo de vida (burnout)',
    category: 'Saúde Mental',
  },
  ...
  {
    code: 'L59',
    description: 'Outros transtornos da pele relacionados com radiação (ex.: exposição solar)',
  ...
  {
    code: 'S82',
    description: 'Fratura da perna, incluindo do tornozelo',
    category: 'Traumatismos e Acidentes',
  },
  {
    code: 'S93',
    description: 'Luxação, entorse e distensão das articulações do tornozelo e do pé',
    category: 'Traumatismos e Acidentes',
  },
  {
    code: 'T14',
    description: 'Traumatismo não especificado de região não especificada do corpo',
    category: 'Traumatismos e Acidentes',
  },
  { code: 'W11', description: 'Queda envolvendo andaime', category: 'Traumatismos e Acidentes' },
  {
    code: 'W13',
    description: 'Queda de, ou através de, edifício ou estrutura',
    category: 'Traumatismos e Acidentes',
  },
  {
    code: 'W20',
    description: 'Atingido por objeto lançado, projetado ou que caiu',
    category: 'Traumatismos e Acidentes',
  },
  ...
  {
    code: 'T65',
    description: 'Efeito tóxico de outras substâncias e das não especificadas',
    category: 'Exposição Ocupacional',
  },
  {
    code: 'Z57',
    description: 'Exposição ocupacional a fatores de risco',
    category: 'Exposição Ocupacional',
  },
];
